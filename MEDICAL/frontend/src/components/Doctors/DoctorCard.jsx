...
const {name, avgRating, totalRating, photo, Special, totalPatients, hospital} = doctor
    ...
    return (
        <div className="p-3 lg:p-5">
            ...
            <div className="mt-2 lg:mt-4 flex items-center justify-between">
                <span className="bg-[#CCF0F3] text-textColor py-1 px-2 lg:py-2 lg:px-6 text-[18px] leading-4 lg:text-[16px] lg:leading-7 font-semibold rounded">{Special}</span>
                ...
                <div className="flex items-center gap-[6px]">
                    ...
                    <span className="text-[14px] leading-6 lg:text-[16px] lg:leading-7 text-textColor font-[400] ">{totalRating}
                    </span>
                </div>
            </div>

            <div className="mt-[16px] lg:mt-5 flex items-center justify-between">
                <div>
