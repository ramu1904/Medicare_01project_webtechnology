...
const Header = () => {
    ...
    return (
    <header className='header flex items-center' ref={headeRef}>
    ...
    {/* ---------------------nav right---------------------- */}
                        ...
                        token && user ? ( <div >
                            ...
                            <Link to='/login'>
                                <button className='bg-primaryColor py-2 px-6 text-white font-[600] h-[44px] flex items-center justify-center
                                 rounded-[50px]'>
                                    Login
                                </button>
                            </Link>)
